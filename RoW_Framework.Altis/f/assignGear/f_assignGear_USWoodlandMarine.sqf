...
_bagmedium = "SP_Carryall_Green";				// carries 240, weighs 30
...
_baseUniform = ["US_1979_ErdlJungle_FieldUniform1","US_1979_ErdlJungle_FieldUniform1_SS","US_1979_ErdlJungle_FieldUniform2","US_1979_ErdlJungle_FieldUniform2_SS"];
_baseHelmet = ["US_1979_ErdlJungle_PASGTHelmet1","US_1979_ErdlJungle_PASGTHelmet2"];
_baseGlasses = [];

// Armored vests
_lightRig = ["SP_Modular2_Green","SP_Modular1_Green"];
_mediumRig = ["SP_Modular2_Green","SP_Modular1_Green"]; 	// default for all infantry classes
_heavyRig = ["SP_Modular2_Green","SP_Modular1_Green"];
