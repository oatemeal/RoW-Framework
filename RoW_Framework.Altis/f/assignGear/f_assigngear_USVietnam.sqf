...
// Backpacks
_bagsmall = "tf_rt1523g";			// carries 120, weighs 20
_bagmedium = "tf_rt1523g";				// carries 240, weighs 30
_baglarge =  "tf_rt1523g"; 			// carries 320, weighs 40
...
// Medium MG
_MMG = "hlc_lmg_M60E4";
_MMGmag = "hlc_20Rnd_762x51_B_M14";
_MMGmag_tr = "hlc_20Rnd_762x51_T_M14";
...
_baseUniform = ["US_1953_WineLeaf_FieldUniform1","US_1953_WineLeaf_FieldUniform2_SS","US_1953_WineLeaf_FieldUniform1_SS"];
_baseHelmet = ["SP_M1Helmet_Green","SP_M1Helmet_GrayDim"];
_baseGlasses = [];

// Armored vests
_lightRig = ["SP_AssaultMolle1_Green"];
_mediumRig = ["SP_AssaultMolle1_Green"]; 	// default for all infantry classes
_heavyRig = ["SP_AssaultMolle1_Green"];
