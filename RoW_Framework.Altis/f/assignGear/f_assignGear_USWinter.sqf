...
// Backpacks
_bagsmall = "US_2001_MarpatWinter_Carryall";			// carries 120, weighs 20
_bagmedium = "US_2001_MarpatWinter_Carryall";				// carries 240, weighs 30
_baglarge =  "US_2001_MarpatWinter_Carryall"; 			// carries 320, weighs 40
...
_baseUniform = ["US_2001_MarpatWinter_FieldUniform1"];
_baseHelmet = ["US_2001_MarpatWinter_PASGTHelmet2"];
_baseGlasses = [];

// Armored vests
_lightRig = ["US_2001_MarpatWinter_PlateCarrier"];
_mediumRig = ["US_2001_MarpatWinter_PlateCarrier"]; 	// default for all infantry classes
_heavyRig = ["US_2001_MarpatWinter_PlateCarrier"];
...
// Handle clothes and helmets and such using the include file called next.
	...
	_unit linkItem "SP_MouthScarf_Black";
};
